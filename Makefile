...
phase1-migrate:
	docker compose exec -T api python -m src.batch.maintenance.run_sql src/infra/migrations/001_create_properties.sql
...
phase2-migrate:
	docker compose exec -T api python -m src.batch.maintenance.run_sql src/infra/migrations/003_create_logs_and_stats.sql
...
phase3-migrate:
	docker compose exec -T api python -m src.batch.maintenance.run_sql src/infra/migrations/004_phase3_features_and_batch_logs.sql

phase3-bootstrap: phase3-migrate

phase3-daily:
	docker compose exec -T api python -m src.batch.features.daily_stats

phase3-feature-check:
	docker compose exec -T api python -m src.batch.features.feature_report

phase4-migrate:
	docker compose exec -T api python -m src.batch.maintenance.run_sql src/infra/migrations/005_phase4_me5.sql

phase4-generate-embeddings:
	docker compose exec -T api python -m src.batch.embeddings.me5_generate
...
phase5-migrate:
	docker compose exec -T api python -m src.batch.maintenance.run_sql src/infra/migrations/006_phase5_learning_logs.sql
	docker compose exec -T api python -m src.batch.maintenance.run_sql src/infra/migrations/007_phase5_ranking_compare_logs.sql
